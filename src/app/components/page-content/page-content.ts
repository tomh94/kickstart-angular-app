...
import { type PortableTextBlock, transformToPortableText } from "@kontent-ai/rich-text-resolver";
import { isVideoType, type LandingPageType, type VideoType } from "../../../model/index";
